      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-[1.4fr_1fr]">
        ...
        <div>
          ...
          <div className="mb-5 flex items-center gap-3">
            <span className="text-xs font-bold tracking-widest text-[#14213D]">
              01
            </span>
            <span className="h-px w-10 bg-[#14213D]" />
          ...
          {/* Heading */}
          <h2 className="mb-5 text-3xl font-extrabold text-[#14213D] md:text-4xl">
        ...
        <div className="h-fit overflow-hidden rounded-md border border-gray-200 shadow-sm">
          {/* Card header */}
          <div className="flex items-center justify-between bg-[#294098] px-6 py-4">
          ...
          <div className="bg-white">
            {serviceDetails.map((item, i) => (
              ...
              >
                ...
                <span className="text-[13px] font-bold text-[#294098]">
                  {item.value}
                </span>
              </div>
            ))}
          ...
          <div className="px-6 py-6">
            <button className="w-full bg-[#294098] py-3 text-xs font-bold tracking-[0.2em] text-white transition-opacity hover:opacity-90">
              GET IN TOUCH →
            </button>
          </div>
        </div>
