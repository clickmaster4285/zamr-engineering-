      ...
      <div className="mx-auto flex max-w-[1468px] flex-wrap items-stretch px-6 lg:px-[130px]">
        {stats.map((stat, i) => (
          ...
          >
            ...
            <span
              className={`${barlow.className} font-medium text-[rgba(255,255,255,0.32)] text-center text-[7px] leading-[9px] sm:text-[8px] sm:leading-[11px] lg:text-left lg:text-[9.5px] lg:leading-[14px]`}
