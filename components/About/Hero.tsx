...
export default function AboutHero() {
  return (
    <section className="relative h-[480px] w-full overflow-hidden sm:h-[560px] md:h-[620px]">
      ...
      {/* Content */}
      <div className="relative z-10 flex h-full flex-col justify-end px-6 pb-16 sm:px-10 sm:pb-20 lg:px-16">
        <h1 className="text-[36px] font-extrabold leading-tight text-white sm:text-[46px] md:text-[52px]">
